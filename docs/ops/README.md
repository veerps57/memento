...
- [`mcp-registry-publishing.md`](mcp-registry-publishing.md) — playbook for publishing Memento to the official MCP Registry. Covers the steady-state pipeline (auto-publish via CI on each CLI release), the first-publish procedure, key rotation, and pinned-binary bumps. Contract: [ADR-0022](../adr/0022-mcp-registry-publishing.md).
